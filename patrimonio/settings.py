...
import os  # Importe o módulo os se ainda não estiver importado
...
SECRET_KEY = 'django-insecure-f9_yps%!v08la#gbs&-r=f5@)^!4h!lg$=8!d&fn_(xy(^e!qo'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Certifique-se de que a pasta está aqui
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = '/login/'  # Define a URL da página de login
...
# Ou configure um servidor SMTP real para produção:
